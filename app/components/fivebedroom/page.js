...
export default function Fivebedroom(){
    return(
        <main className="bg-gray-200">
            <p className="p-5 lg:block text-sm text-gray-500 lg:p-10 md:p-10"><Link href={"/"}>Home</Link> → <span className="text-sm text-gray-200 text-gray-500"><Link href={"/components/rent"}>Flat Apartment for Rent</Link> → </span><span className="text-sm text-gray-200 text-gray-500"><Link href={"/components/fivebedroom"}>fivebedroom</Link></span></p>
            <p className="text-2xl text-gray-500 p-4 font-bold">Flat & Apartment For <span className="text-yellow-300">RENT</span> in Nigeria.</p>
             <p className=" lg:block mx-5 py-5">The average price of houses for rent is <span className="font-bold">₦5,482,829</span> The most expensive house costs <span className="font-bold">₦70,000,000.</span> while the cheapest costs <span className="font-bold">₦70,000.</span> We have a total of <span className="font-bold">19,178</span> Flat Apartment for rent in Nigeria updated on 03 Sep 2025. Among these properties are houses, lands, shops, apartments, flats and commercial spaces . Every Real Estate in Nigeria posted on this site is verified by real estate agents . We also have cheap houses for rent and cheap houses for sale . Refine your property search by price, number of beds and type of property.</p>
                   <div className="p-5 border my-3 ml-5">
                        ...
                        <h1 className="mt-10 text-center text-4xl italic text-black text-semibold">FIVR-BEDROOM PROPERTIES</h1>
