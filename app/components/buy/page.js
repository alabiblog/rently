...
export default function Buy(){
    return(
        <main className="min-h-screen max-w-screen">
                     <p className="hidden lg:block text-sm text-gray-500 p-10">Home → <span className="text-sm text-gray-200 text-gray-500">Flat Apartment for Rent</span></p>
                     <p className="text-2xl text-gray-500 p-4 font-bold">Flat & Apartment For <span className="text-yellow-300">SALE</span> in Nigeria.</p>
                    ...
                    <div className=" md:flex lg:flex gap-5">
                        <div className="w-95 g h-full  md:w-220 lg:w-220">
                            <div className="p-5 border my-3 ml-5">
                                <h1 className="text-sm text-gray-500"> 1 Bedroom |<span> 2 Bedroom |</span><span> 3 Bedroom |</span><span> 4 Bedroom |</span><span> 5 Bedroom |</span><span> 6 Bedroom |</span></h1>
                                <h1 className="text-sm text-gray-500 mt-3"> Studio Apartment |<span> Mini Flat |</span><span> Penthouse |</span><span> Selfcontain |</span><span> Duplex |</span></h1>
                                <h1 className="text-sm text-gray-500 mt-3"> Abuja |<span> Nasarawa |</span><span> Lagos |</span><span> Benin |</span><span> Portharcourt |</span></h1>
                            </div>
                        ...
                        <div className="relative  w-95  h-200  md:w-90 lg:w-90">
                            ...
                            <div className="flex justify-between p-2">
                                ...
                                <hr className="mx-5"/>
                            <div className="flex justify-between p-2">
                                <h1 className="ml-2  text-sm">Studio Apartment</h1>
                                <h1 className="text-sm">10</h1>
                            </div>
                                <hr className="mx-5"/>
                            <div className="flex justify-between p-2">
                                <h1 className="ml-2 text-sm">Mini Flat</h1>
                                <h1 className="text-sm">7</h1>
                            </div>
                                <hr className="mx-5"/>
                            <div className="flex justify-between p-2">
                                <h1 className="ml-2 text-sm">Panthouse</h1>
                                <h1 className="text-sm">5</h1>
                            </div>
                                <hr className="mx-5"/>
                            <div className="flex justify-between p-2">
                                <h1 className="ml-2 text-sm">Selfcontain</h1>
                                <h1 className="text-sm">20</h1>
                            </div>
                                <hr className="mx-5"/>
                            <div className="flex justify-between p-2">
                                <h1 className="ml-2 text-sm">Duplex</h1>
                           ...
                           <div className="rounded-xl border h-50 mt-20">
                            <Image
                            width={70}
                            height={80}
                            src={"/Mini111.png"}
                            ...
                            <p className="p-4 text-sm">Discover which neighbourhood in Nigeria is the best place to live</p>
                           </div>
                           <div className="rounded-xl border h-60 mt-20">
