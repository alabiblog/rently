...
export default function Benin(){
    return(
        <main  className="bg-gray-200">
             <p className="p-5 lg:block text-sm text-gray-500 lg:p-10 md:p-10"><Link href={"/"}>Home</Link> → <span className="text-sm text-gray-200 text-gray-500"><Link href={"/components/rent"}>Flat Apartment for Rent</Link> → </span><span className="text-sm text-gray-200 text-gray-500"><Link href={"/components/benin"}>benin</Link></span></p>
           <p className="text-2xl text-gray-500 p-4 font-bold">Flat & Apartment For <span className="text-yellow-300">RENT</span> in Nigeria.</p>
            ...
            <h1 className="mt-10 text-center text-4xl italic text-black text-semibold">PROPERTIES LOCATED IN BENIN</h1>
